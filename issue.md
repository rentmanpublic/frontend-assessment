...
**I want to** add transport details (vehicle, driver, departure time) to an event,

**So that** the delivery logistics are planned alongside the rest of the event.

# Acceptance criteria

- The transport planner can add one or more transport entries to an event
...
- The transport section is visible on the events module in the software
